...
/* This script lets people register for the site (in theory.). */
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	{
		$problem = true;
		print '<p class="text--error">Your password does not match the confirmed password!</p>';
	}
	...
	if (!$problem)
	{
		...
		// Note: Only outlook seems to receive the email.
		mail($_POST['email'], 'Registration Confirmation', $body, 'From: rpedudev@gmail.com');
